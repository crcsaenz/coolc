...
#define FEATURE_TYPE_METHOD 0
#define FEATURE_TYPE_ATTR 1

#define EXPR_TYPE_NO_EXPR 0
#define EXPR_TYPE_OTHER 1
...
public:
   method_class(Symbol a1, Formals a2, Symbol a3, Expression a4) {
      ...
      return_type = a3;
      expr = a4;
       featureType = FEATURE_TYPE_METHOD;
   }
