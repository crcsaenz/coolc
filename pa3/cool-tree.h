...
public:
   ...
   virtual Program copy_Program() = 0;
    virtual bool inheritanceCheck(ClassTable *classTable) = 0;
    virtual void gatherDeclarations(ClassTable *classTable) = 0;
    virtual void typecheck(ClassTable *classT,
                           SymbolTable<Symbol, method_class> *methods,
                           SymbolTable<Symbol, Symbol> *objects) = 0;
...
public:
   ...
   virtual Class_ copy_Class_() = 0;
    virtual void gatherDeclarations(ClassTable *classTable) = 0;
    virtual void checkDeclarations(ClassTable *classTable) = 0;
    virtual void typecheck(ClassTable *classT,
                           SymbolTable<Symbol, method_class> *methods,
                           SymbolTable<Symbol, Symbol> *objects) = 0;
...
public:
   ...
   virtual Feature copy_Feature() = 0;
    virtual void gatherDeclarations(ClassTable *classTable, class__class *c) = 0;
    virtual void checkDeclarations(ClassTable *classTable, class__class *c) = 0;
    virtual void typecheck(ClassTable *classT,
                           SymbolTable<Symbol, method_class> *methods,
                           SymbolTable<Symbol, Symbol> *objects) = 0;
...
public:
   ...
   virtual Expression copy_Expression() = 0;
    virtual Symbol typecheck(ClassTable *classT,
                           SymbolTable<Symbol, method_class> *methods,
                           SymbolTable<Symbol, Symbol> *objects) = 0;
...
public:
   ...
   void dump(ostream& stream, int n);
    bool inheritanceCheck(ClassTable *classTable);
    void gatherDeclarations(ClassTable *classTable);
    void typecheck(ClassTable *classT,
                   SymbolTable<Symbol, method_class> *methods,
...
public:
   ...
   void dump(ostream& stream, int n);
    ...
    bool inheritanceCheck(ClassTable *classTable);
    void gatherDeclarations(ClassTable *classTable);
    void checkDeclarations(ClassTable *classTable);
    void typecheck(ClassTable *classT,
                   SymbolTable<Symbol, method_class> *methods,
                   SymbolTable<Symbol, Symbol> *objects);
...
public:
   ...
   void dump(ostream& stream, int n);
    ...
    void gatherDeclarations(ClassTable *classTable, class__class *c);
    void checkDeclarations(ClassTable *classTable, class__class *c);
    void typecheck(ClassTable *classT,
                   SymbolTable<Symbol, method_class> *methods,
                   SymbolTable<Symbol, Symbol> *objects);
...
public:
   ...
   void dump(ostream& stream, int n);
    ...
    Symbol getTypeDecl() { return type_decl; }
    Expression getExpr() { return expr; }
    Symbol typecheck(ClassTable *classT,
                   SymbolTable<Symbol, method_class> *methods,
                   SymbolTable<Symbol, Symbol> *objects);
...
public:
   ...
   void dump(ostream& stream, int n);
    Expression getExpr() { return expr; }
    Symbol getTypeName() { return type_name; }
    Symbol getName() { return name; }
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
    Expression getPred() { return pred; }
    Expression getThenExp() { return then_exp; }
    Expression getElseExp() { return else_exp; }
    Symbol typecheck(ClassTable *classT,
                   SymbolTable<Symbol, method_class> *methods,
                   SymbolTable<Symbol, Symbol> *objects);
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
    Expressions getBody() { return body; }
    Symbol typecheck(ClassTable *classT,
                   SymbolTable<Symbol, method_class> *methods,
                   SymbolTable<Symbol, Symbol> *objects);
...
public:
   ...
   Expression copy_Expression();
   void dump(ostream& stream, int n);
    Symbol getIdentifier() { return identifier; }
    Symbol getTypeDecl() { return type_decl; }
    Expression getInit() { return init; }
    Expression getBody() { return body; }
    Symbol typecheck(ClassTable *classT,
